...
\alert{
	...
	nor any form of activities that
...
``Point'' refers to your score in the tournament,  % informal
...
\begin{itemize}
	...
	\item During the group stage (Round I),
	      ...
	      Although matches may be separately scheduled,  % how about "asynchronously"
