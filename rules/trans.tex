...
\textsf{Score} refers to your in-game play result.
\textsf{Point} refers to your score in the tournament,  % informal
derived from the play result
using a calculating procedure known as \textsf{scoring}.
...
\begin{itemize}
	...
	\item During the group stage (Round I),
	      ...
	      While matches could be separately scheduled,  % how about "asynchronously"
