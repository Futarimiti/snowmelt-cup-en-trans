<!-- NOTE: "song" could be replaced with "charts" for clarity -->

# Rules

Any personnels  <!-- word choice TODO -->
...
2.  Contestants will only compete with each other
...
4.  Round I: Group Stage, 16 into 8
    ...
    *6 non-repeating songs*
    ...
    A pick and a ban cancel each other out
...
6.  Round III: Comeback <!-- expect better substitutes --> matches & Finals
...
Only the winning contestant needs to submit the handcam
at the end of the match.  <!-- team? -->
...
in case of wrongful overtime penalty.  <!-- need better wording -->
...
All prizes are awarded in form of cash.  <!-- eughw idk; maybe "redeem"? -->
